...
export declare function readAnalyticsId(): Promise<string>;
/**
 * This is the first way that the analytics id was saved.
 */
export declare function readFirstLegacyAnalyticsId(): Promise<string>;
/**
 * This is the same way the analytics id is saved now, but using buidler as the
 * name of the project for env-paths
 */
export declare function readSecondLegacyAnalyticsId(): Promise<string>;
