...
exports.runScriptWithRedspot = exports.runScript = void 0;
...
const log = debug_1.default('redspot:core:scripts-runner');
...
async function runScriptWithRedspot(redspotArguments, scriptPath, scriptArgs = [], extraNodeArgs = [], extraEnvVars = {}) {
    ...
    return runScript(scriptPath, scriptArgs, [
        ...
        ...env_variables_1.getEnvVariablesMap(redspotArguments),
        ...extraEnvVars
    });
}
exports.runScriptWithRedspot = runScriptWithRedspot;
/**
...
function getTsNodeArgsIfNeeded(scriptPath) {
    ...
    // take forever
    if (execution_mode_1.isRunningRedspotCoreTests() ||
