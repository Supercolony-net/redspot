import { ProjectPathsConfig, ProjectPathsUserConfig, RedspotConfig, RedspotUserConfig } from '../../../types';
/**
 ...
 */
export declare function resolveConfig(userConfigPath: string, userConfig: RedspotUserConfig): RedspotConfig;
/**
