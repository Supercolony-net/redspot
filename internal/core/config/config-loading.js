...
function loadConfigAndTasks(redspotArguments) {
    let configPath = redspotArguments !== undefined ? redspotArguments.config : undefined;
    ...
    for (const extender of context_1.RedspotContext.getRedspotContext().configExtenders) {
...
function deepFreezeUserConfig(config, propertyPath = []) {
    ...
    return new Proxy(config, {
        ...
        set(target, property, value, receiver) {
            throw new errors_1.RedspotError(errors_list_1.ERRORS.GENERAL.USER_CONFIG_MODIFIED, {
...
function analyzeModuleNotFoundError(error, configPath) {
    ...
    if (peerDependencies['@nomiclabs/buidler'] !== undefined) {
        throw new errors_1.RedspotError(errors_list_1.ERRORS.PLUGINS.BUIDLER_PLUGIN, {
    ...
    if (missingPeerDependenciesNames.length > 0) {
        throw new errors_1.RedspotError(errors_list_1.ERRORS.PLUGINS.MISSING_DEPENDENCIES, {
            plugin: packageJson.name,
