...
function loadTsNode() {
    try {
        ...
        throw new errors_1.RedspotError(errors_list_1.ERRORS.GENERAL.TYPESCRIPT_NOT_INSTALLED);
    }
    try {
        require.resolve('ts-node');
    }
    catch (error) {
        throw new errors_1.RedspotError(errors_list_1.ERRORS.GENERAL.TS_NODE_NOT_INSTALLED);
    }
