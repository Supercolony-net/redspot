...
You can learn how to use Redspot by reading the [Getting Started guide](../getting-started).`,
        ...
        INVALID_NODE_VERSION: {
            number: 2,
            message: "Redspot doesn't support your Node.js version. It should be %requirement%.",
...
Please [report it](https://github.com/nomiclabs/redspot/issues/new) to help us improve Redspot.`,
        ...
        CONTEXT_HRE_NOT_DEFINED: {
            number: 6,
            message: 'Redspot Runtime Environment is not defined in the RedspotContext.',
...
Please [report it](https://github.com/nomiclabs/redspot/issues/new) to help us improve Redspot.`,
        ...
        CONTEXT_HRE_ALREADY_DEFINED: {
            number: 7,
            message: 'Redspot Runtime Environment is already defined in the RedspotContext',
...
Please [report it](https://github.com/nomiclabs/redspot/issues/new) to help us improve Redspot.`,
        ...
        NON_LOCAL_INSTALLATION: {
            number: 12,
            message: 'Trying to use a non-local installation of Redspot, which is not supported.\nPlease install Redspot locally using npm or Yarn, and try again.',
...
Read the [documentation](https://redspot.org/config/#networks-configuration) to learn how to define custom networks.`,
        ...
        INVALID_GLOBAL_CHAIN_ID: {
            number: 101,
            message: 'Redspot was set to use chain id %configChainId%, but connected to a chain with id %connectionChainId%.',
...
Please double check your task definitions.`,
        ...
        PARAM_CLASHES_WITH_REDSPOT_PARAM: {
            number: 202,
            message: 'Could not set param %paramName% for task %taskName% because its name is used as a param for Redspot.',
...
You must always use slashes (/) in Solidity imports.`,
        ...
        INVALID_IMPORT_PROTOCOL: {
            number: 406,
            message: "Invalid import %imported% from %from%. Redspot doesn't support imports via %protocol%.",
...
You can only import files thar are available locally or installed through npm.`,
        ...
        INVALID_IMPORT_ABSOLUTE_PATH: {
            number: 407,
            message: "Invalid import %imported% from %from%. Redspot doesn't support imports with absolute paths.",
...
We recommend not using this kind of dependencies.`,
        ...
        JSONRPC_UNSUPPORTED_NETWORK: {
            number: 605,
            message: 'Unsupported network for JSON-RPC server. Only redspot is currently supported.',
