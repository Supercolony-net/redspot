...
const log = debug_1.default('redspot:core:analytics');
...
async function getClientId() {
    ...
    if (clientId === undefined) {
        clientId =
            (_a = (await global_dir_1.readSecondLegacyAnalyticsId())) !== null && _a !== void 0 ? _a : (await global_dir_1.readFirstLegacyAnalyticsId());
        if (clientId === undefined) {
...
async function getRedspotVersion() {
