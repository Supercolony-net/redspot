...
import { AccountSigner, ApiPromise, Keyring, LocalKeyringPair, Registry, Signer, WsProvider } from './provider';
/**
...
export declare type ActionType<ArgsT extends TaskArguments> = (taskArgs: ArgsT, env: RedspotRuntimeEnvironment, runSuper: RunSuperFunction<ArgsT>) => Promise<any>;
...
export declare type RedspotParamDefinitions = {
    [param in keyof Required<RedspotArguments>]: CLIOptionalParamDefinition<RedspotArguments[param]>;
};
...
export interface Network {
    ...
    gasLimit?: BN;
    utils: {
        encodeSalt(salt?: Uint8Array | string | null, signerAddress?: string): Promise<Uint8Array>;
    };
}
/**
 ...
 */
export declare type EnvironmentExtender = (env: RuntimeEnvironment) => void;
